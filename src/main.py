...
class DateDataForm:
    ...
    username="lecteur1"
    password=""
    dateStart   =  date(2015,9,3)
    dateEnd     =  date(2016,5,15)
    online=False
    areDownload=False
    areParse=False
    ...
    def getDateToUrl(self):
        ret = "&startDay="+dateStart.day
        ret+= "&startMonth="+dateStart.month
        ret+= "&startYear="+dateStart.year
        ret+= "&endDay="+dateEnd.day
        ret+= "&endMonth="+dateEnd.month
        ret+= "&endYear="+dateEnd.year
    ...
    def getICS(self):
        ...
        with open('output.ics', 'wb') as f:
                ...
                c.setopt(c.URL,"https://planif.esiee.fr:8443/jsp/custom/modules/plannings/ical.jsp?startDay=01&startMonth=11&startYear=2015&endDay=15&endMonth=05&endYear=2016&ClientCal=palm")
